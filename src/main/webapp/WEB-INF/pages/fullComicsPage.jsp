...
<title>Читати комікс: ${comics.title}</title>
	...
	<div class="container">
		...
		<div class="row pt-5 mt-3">
			...
			<div class="col-lg-8">
				...
				<!-- Author -->
				<p class="lead">
					by <em>${comics.autorName}</em>
				</p>

				<hr>

				<!-- Date/Time -->
				<p class="text-muted">Posted on ${comics.date}</p>

				<hr>

				<!-- Preview Image -->
				<img class="img-fluid rounded"
					src="<c:url value="/comics/image.html?id=${comics.id}"/>" alt="">

				<hr>

				<!-- Post Content -->
				<p class="lead mb-5">${comics.description}</p>
				<hr>
				<!-- Comments Form -->
				<c:choose>
					<c:when test="${!empty user.nik}">
						<div class="card my-4">
							...
							<div class="card-body">
								<form:form
									action="${pageContext.request.contextPath}/comics/add_comment"
